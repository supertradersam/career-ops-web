...
const CANONICAL_REPO = 'https://github.com/supertradersam/career-ops-web.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/supertradersam/career-ops-web/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/supertradersam/career-ops-web/releases/latest';
