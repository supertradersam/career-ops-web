...
* adapt contacto mode by contact type (recruiter/HM/peer/interviewer) ([9fd5a90](https://github.com/supertradersam/career-ops-web/commit/9fd5a90896f20020f48455cd079b64fed491b89f))
...
* add Block G — posting legitimacy assessment ([3a636ac](https://github.com/supertradersam/career-ops-web/commit/3a636ac586659bb798ef46a0a9798478a1e28b0a))
* add Claude Code plugin manifests (path-stable) ([62b767d](https://github.com/supertradersam/career-ops-web/commit/62b767dcc56e4c875ed70bf4fe799c254ecf8eea))
* add follow-up cadence tracker mode ([4308c37](https://github.com/supertradersam/career-ops-web/commit/4308c375033c6df430308235f4324658a8353b81))
...
* add Nix flake devshell with Playwright support ([c579fcd](https://github.com/supertradersam/career-ops-web/commit/c579fcddebf793f00cfad8534fd74085c09017fb))
* add OpenCode slash commands for career-ops ([#67](https://github.com/supertradersam/career-ops-web/issues/67)) ([93caaed](https://github.com/supertradersam/career-ops-web/commit/93caaed49cbc9f3214f9beb66fb2281c3f2370e6))
* add scan.mjs — zero-token portal scanner ([8c19b2b](https://github.com/supertradersam/career-ops-web/commit/8c19b2b59f7087689e004f3d48e912f291911373))
...
* expand portals.example.yml with 8 dev-tools companies + 23 search queries ([#140](https://github.com/supertradersam/career-ops-web/issues/140)) ([b7f555d](https://github.com/supertradersam/career-ops-web/commit/b7f555d7b9a7b23c875fa0d35584df534961dabe))
* **i18n:** add Japanese README + language modes for Japan market ([20a2c81](https://github.com/supertradersam/career-ops-web/commit/20a2c817486968ca42a534aa86838c797d599c10))
...
* 10 bug fixes — resource leaks, command injection, Unicode, navigation ([cb01a2c](https://github.com/supertradersam/career-ops-web/commit/cb01a2c2e3b7fc334b1c4594749ea40b0da8fc62))
* add data/ fallback to UpdateApplicationStatus ([#55](https://github.com/supertradersam/career-ops-web/issues/55)) ([3512b8e](https://github.com/supertradersam/career-ops-web/commit/3512b8ef4eb8ca967bc967664f8798af42b58a52))
...
* align portals.example.yml indentation for new companies ([26a6751](https://github.com/supertradersam/career-ops-web/commit/26a675173e64dac09fd1524ff9a7c7061520e057))
...
* correct dashboard launch path in docs ([#80](https://github.com/supertradersam/career-ops-web/issues/80)) ([2b969ee](https://github.com/supertradersam/career-ops-web/commit/2b969eea5f6bbc8f29b9e42bedb59312379e9f02))
...
* filter expired WebSearch links before they reach the pipeline ([#57](https://github.com/supertradersam/career-ops-web/issues/57)) ([ce1c5a3](https://github.com/supertradersam/career-ops-web/commit/ce1c5a3c7eea6ebce2c90aebba59d6e26b790d3f))
* improve default PDF readability ([#85](https://github.com/supertradersam/career-ops-web/issues/85)) ([10034ec](https://github.com/supertradersam/career-ops-web/commit/10034ec3304c1c79ff9c9678c7826ab77c0bcbf7))
* liveness checks ignore nav/footer Apply text, expired signals win ([3a3cb95](https://github.com/supertradersam/career-ops-web/commit/3a3cb95bdf09235509df72e30b3077623f571ea1))
...
* use candidate name from profile.yml in PDF filename ([7bcbc08](https://github.com/supertradersam/career-ops-web/commit/7bcbc08ca6184362398690234e49df0ac157567f))
...
* use fileURLToPath for cross platform compatible paths in tracker scripts ([#32](https://github.com/supertradersam/career-ops-web/issues/32)) ([#58](https://github.com/supertradersam/career-ops-web/issues/58)) ([ab77510](https://github.com/supertradersam/career-ops-web/commit/ab775102f4586ae4663a593b519927531be27122))
* use hi@santifer.io in English README ([5518d3d](https://github.com/supertradersam/career-ops-web/commit/5518d3dd07716137b97bb4d8c7b5264b94e2b9e9))


### Performance Improvements

* compress hero banner from 5.7MB to 671KB ([dac4259](https://github.com/supertradersam/career-ops-web/commit/dac425913620fe0a66916dda7ba8d8fc4c427d51))
